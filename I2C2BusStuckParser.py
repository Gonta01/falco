...
output_file = "fprime-falco/Falco/Drv/I2c2Driver/I2C2DriverFuncs.template.cpp"
...
gpio_expr = {
    "PIO_PDR":  "orig & ~0x18000000",
    "PIO_PER":  "orig |  0x18000000",
    "PIO_MDER": "orig |  0x18000000",
    "PIO_MDDR": "orig & ~0x18000000",
    "PIO_OER":  "orig |  0x18000000",
    "PIO_ODR":  "orig & ~0x18000000",
}
...
# Pattern to match assignments to PIO_PORT_D
pattern_template = r"\(\(pio_registers_t\s*\*\)\s*PIO_PORT_D\)->({reg})\s*=\s*([^;]+);"
...
def generate_line_i2c(reg, value):
    return f"    ((pio_registers_t*)PIO_PORT_D)->{reg} = {hex(value)};"
...
print("✅ Done: I2C2DriverFuncs.template.cpp generated with correct values.")