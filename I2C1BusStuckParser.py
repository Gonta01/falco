...
output_file = "fprime-falco/Falco/Drv/I2c1Driver/I2C1DriverFuncs.template.cpp"
...
# Pattern to match assignments to PIO_PORT_B
pattern_template = r"\(\(pio_registers_t\s*\*\)\s*PIO_PORT_B\)->({reg})\s*=\s*([^;]+);"
...
def generate_line_i2c(reg, value):
    return f"    ((pio_registers_t*)PIO_PORT_B)->{reg} = {hex(value)};"
...
print("✅ Done: I2C1DriverFuncs.template.cpp generated with correct values.")