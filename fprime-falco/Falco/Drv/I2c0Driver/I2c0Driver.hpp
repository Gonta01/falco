#ifndef I2c0Driver_HPP
#define I2c0Driver_HPP

#include "Falco/Drv/I2c0Driver/I2c0DriverComponentAc.hpp"
#include "FreeRTOS.h"
...
namespace Falco {
  ...
  class I2c0Driver :
    public I2c0DriverComponentBase
  {
    ...
    public:
      ...
      //! Construct object I2c0Driver
      //!
      I2c0Driver(
          const char *const compName /*!< The component name*/
      );

      //! Destroy object I2c0Driver
      //!
      ~I2c0Driver();

    PRIVATE:
      EventGroupHandle_t eventGroupHandleI2c0;
      ...
      static void I2c0Callback(uintptr_t thisObjects);
