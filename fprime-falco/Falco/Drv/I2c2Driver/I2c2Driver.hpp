#ifndef I2c2Driver_HPP
#define I2c2Driver_HPP

#include "Falco/Drv/I2c2Driver/I2c2DriverComponentAc.hpp"
#include "FreeRTOS.h"
...
namespace Falco {
  ...
  class I2c2Driver :
    public I2c2DriverComponentBase
  {
    ...
    public:
      ...
      //! Construct object I2c2Driver
      //!
      I2c2Driver(
          const char *const compName /*!< The component name*/
      );

      //! Destroy object I2c2Driver
      //!
      ~I2c2Driver();

    PRIVATE:
      EventGroupHandle_t eventGroupHandleI2c2;
      ...
      static void I2c2Callback(uintptr_t thisObjects);
