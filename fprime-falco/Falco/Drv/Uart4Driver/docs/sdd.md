...
Buffer that is intended to be transmitted is copied into non-cached buffer (UART4Buffer) and then this buffer is provided to DMA which transfers data from buffer to transmit register. During data transmission receiver is disabled.
