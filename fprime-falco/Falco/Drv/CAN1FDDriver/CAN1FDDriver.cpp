#include <Falco/Drv/CAN1FDDriver/CAN1FDDriver.hpp>
...
CAN1FDDriver ::CAN1FDDriver(const char* compName)
    : CAN1FDDriverComponentBase(compName)
{

}

CAN1FDDriver ::~CAN1FDDriver(void) {}

void CAN1FDDriver::configure(Drv::CAN::NominalBitRate nominalBitRate, Drv::CAN::DataBitRate dataBitRate) {
  ...
  MCAN1_BitTimingCalculationGet(&mcanBitTimingSetup, &mcanBitTiming);
  MCAN1_BitTimingSet(&mcanBitTiming);

  configMCAN();
}

Drv::CAN::Status CAN1FDDriver::receive_handler(NATIVE_INT_TYPE portNum, Fw::Buffer& buffer, Drv::CAN::FDFlags& flags, U32 timeoutMs) {
...
Drv::CAN::Status CAN1FDDriver::transmit_handler(NATIVE_INT_TYPE portNum, Fw::Buffer& buffer, const Drv::CAN::FDFlags& flags, U32 timeoutMs) {
