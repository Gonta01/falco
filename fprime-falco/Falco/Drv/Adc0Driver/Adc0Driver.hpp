...
// \title  Adc0Driver.hpp
// \author user
// \brief  hpp file for Adc0Driver component implementation class
// ======================================================================

#ifndef Falco_Adc0Driver_HPP
#define Falco_Adc0Driver_HPP

#include "Falco/Drv/Adc0Driver/Adc0DriverComponentAc.hpp"
#include "Falco/Drv/AdcCommon/ADCBase.hpp"

namespace Falco {

  class Adc0Driver :
    public Adc0DriverComponentBase, public Base::ADC
  {
    ...
    public:
      ...
      //! Construct Adc0Driver object
      Adc0Driver(
          const char* const compName //!< The component name
      );

      //! Destroy Adc0Driver object
      ~Adc0Driver();
