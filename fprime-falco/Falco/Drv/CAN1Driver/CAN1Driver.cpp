#include <Falco/Drv/CAN1Driver/CAN1Driver.hpp>
...
CAN1Driver ::CAN1Driver(const char* compName)
    : CAN1DriverComponentBase(compName)
{

}

CAN1Driver ::~CAN1Driver(void) {}

void CAN1Driver::configure(Drv::CAN::NominalBitRate nominalBitRate) {
...
Drv::CAN::Status CAN1Driver::receive_handler(NATIVE_INT_TYPE portNum, Fw::Buffer& buffer, Drv::CAN::StandardFlags& flags, U32 timeoutMs) {
...
Drv::CAN::Status CAN1Driver::transmit_handler(NATIVE_INT_TYPE portNum, Fw::Buffer& buffer, const Drv::CAN::StandardFlags& flags, U32 timeoutMs) {
