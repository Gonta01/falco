// ======================================================================
// \title  FalcoPrimeTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef FALCOPRIME_FALCOPRIMETOPOLOGY_HPP
#define FALCOPRIME_FALCOPRIMETOPOLOGY_HPP
// Included for access to FalcoPrime::TopologyState and FalcoPrime::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <FalcoPrime/Top/FalcoPrimeTopologyDefs.hpp>

// Remove unnecessary FalcoPrime:: qualifications
 ...
 * FalcoPrime::TopologyState see: FalcoPrimeTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type FalcoPrime::TopologyState see: FalcoPrimeTopologyDefs.hpp.
 *
