// ======================================================================
// \title  FalcoPrimeTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef FALCOPRIME_FALCOPRIMETOPOLOGYDEFS_HPP
#define FALCOPRIME_FALCOPRIMETOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "FalcoPrime/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `FalcoPrime::TopologyState`. Only the type
...
namespace IMU1Manager {
enum { WARN = 5, FATAL = 15 };
}
namespace IMU2Manager {
enum { WARN = 5, FATAL = 15 };
}
namespace EnvSensManager {
enum { WARN = 5, FATAL = 15 };
}
