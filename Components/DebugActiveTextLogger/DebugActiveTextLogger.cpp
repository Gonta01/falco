...
#include <Components/DebugActiveTextLogger/DebugActiveTextLogger.hpp>
...
namespace DebugLogger {
    ...
    DebugActiveTextLogger::DebugActiveTextLogger(const char* name) :
        DebugActiveTextLoggerComponentBase(name),
        m_log_file()
    {

    }

    DebugActiveTextLogger::~DebugActiveTextLogger()
    {

    }

    void DebugActiveTextLogger::init(NATIVE_INT_TYPE queueDepth, NATIVE_INT_TYPE instance)
    {
        DebugActiveTextLoggerComponentBase::init(queueDepth,instance);
    }
    ...
    void DebugActiveTextLogger::TextLogger_handler(NATIVE_INT_TYPE portNum,
                                                  FwEventIdType id,
                                                  Fw::Time &timeTag,
    ...
    void DebugActiveTextLogger::TextQueue_internalInterfaceHandler(const Fw::InternalInterfaceString& text)
    {
    ...
    bool DebugActiveTextLogger::setLogFile(const char* fileName, const U32 maxSize, const U32 maxBackups)
    {
        FW_ASSERT(fileName != nullptr);

        return this->m_log_file.setLogFile(fileName, maxSize, maxBackups);
    }
