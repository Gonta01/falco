...
#ifndef DEBUGLOGGERLOGFILE_HPP_
#define DEBUGLOGGERLOGFILE_HPP_
...
namespace DebugLogger {
    ...
    struct LogFile {
        ...
        static constexpr uint32_t fileFormatSize = 5;
        char fileFormat[fileFormatSize] = ".txt";
    };

}
#endif /* DEBUGLOGGERLOGFILE_HPP_ */
